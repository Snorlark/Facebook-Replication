    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions:  [
          (_currentIndex == 2) ?
          IconButton(
            onPressed: () => {customOptionDialog(context, title: 'Are you sure?', content: 'You are about to sign out', onYes: () => Navigator.pushReplacementNamed(context, '/login'))}, 
            icon: const Icon(
              Icons.logout,
              color: Colors.white,
            ),
